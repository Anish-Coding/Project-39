...
function preload(){
  ...
  winImg = loadImage("images/download(2).png")
  ...
  endSound = loadSound("mixkit-arcade-retro-game-over-213.wav")
}
...
function setup(){
  ...
  winSprite = createSprite(300,300,10,10);
  winSprite.addImage("winSprite", winImg)
...
function draw() {
  ...
  if(score<399){
    ...
    console.log("win: ",winSprite.y)
    console.log("vis: ",winSprite.visible)
  } else {
    player.destroy();
    coinGp.destroyEach();
    bombGp.destroyEach();
